...
class DevicePresetService:
    ...
    def insert(self, preset_id: int, template_id: int, ordered_number: int):
        ...
        if ordered_number > max_ordered_number + 1:
            raise ValueError(
                f"The ordered_number={ordered_number} value exceeds the allowed limit for preset_id={preset_id}."
            )
        ...
        new_device_preset = DevicePresets(
            template_id=template_id, ordered_number=ordered_number, preset_id=preset_id
        )
