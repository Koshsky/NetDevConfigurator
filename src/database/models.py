...
class Ports(Base):
    __tablename__ = "ports"
    __table_args__ = (PrimaryKeyConstraint("id", name="ports_pkey"),)
...
class Protocols(Base):
    ...
    __table_args__ = (PrimaryKeyConstraint("id", name="protocols_pkey"),)
...
class Devices(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "(dev_type)::text = ANY (ARRAY[('router'::character varying)::text, ('switch'::character varying)::text])",
            name="check_dev_type",
        ),
        ForeignKeyConstraint(
            ["company_id"],
...
class Templates(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["family_id"], ["families.id"], name="template_pieces_family_id_fkey"
        ),
...
class DevicePorts(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["devices.id"],
            ondelete="CASCADE",
            name="device_ports_device_id_fkey",
        ),
        ForeignKeyConstraint(
            ["port_id"],
            ["ports.id"],
            ondelete="CASCADE",
            name="device_ports_port_id_fkey",
        ),
...
class DeviceProtocols(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["devices.id"],
            ondelete="CASCADE",
            name="device_protocols_device_id_fkey",
        ),
        ForeignKeyConstraint(
            ["protocol_id"],
            ["protocols.id"],
            ondelete="CASCADE",
            name="device_protocols_protocol_id_fkey",
        ),
...
class Presets(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["device_id"], ["devices.id"], name="presets_device_id_fkey"
        ),
...
class DevicePresets(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ...
            ["presets.id"],
            ondelete="CASCADE",
            name="device_templates_preset_id_fkey",
        ),
        ForeignKeyConstraint(
            ["template_id"],
            ["templates.id"],
            ondelete="CASCADE",
            name="device_templates_template_id_fkey",
        ),
